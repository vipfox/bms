;(function (jQuery){
	...
	this.init = function(f){
		...
		$("#areaopt .areaopt_btn[rel='confirm']").click(function(){
			//confirm
			if($("#areaopt_city").val()!='' && $("#areaopt_province").val()){
				//$(doml).val($("#areaopt_province").val());
				$(doml).val($("#areaopt_province").val() + ' ' + $("#areaopt_city").val());
				$('#areaopt_div').remove();

			}else if($("#areaopt_province").val()!='' && $("#areaopt_city").val()==''){
				$(doml).val($("#areaopt_province").val());
				$('#areaopt_div').remove();
	...
	this.getzone = function(index1,index2){
		...
		$("#areaopt .areaopt_zone a").click(function(){
			...
			if($("#areaopt_province").val()){
				province_val=$("#areaopt_province").val();	
			}else if(typeof(province_val) == "undefined"){
				province_val='';
			}
			
			if($("#areaopt_city").val()){
				city_val=$("#areaopt_city").val();	
			}else if(typeof(city_val) == "undefined"){
				city_val='';
			}
			$(doml).val(province_val + ' ' + city_val + ' ' + $("#areaopt_zone").val());
			$('#areaopt_div').remove();
			return false;
		});
		return false;
