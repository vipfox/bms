...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo (C("PUBLIC_URL")); ?>productList/fonts/pixelfabric-clothes/style.css" />
	<!-- General demo styles & header -->
	<link rel="stylesheet" type="text/css" href="<?php echo (C("PUBLIC_URL")); ?>productList/css/demo.css" />
	 <!-- Flickity gallery styles -->
	<link rel="stylesheet" type="text/css" href="<?php echo (C("PUBLIC_URL")); ?>productList/css/flickity.css" />
	<!-- Component styles -->
	<link rel="stylesheet" type="text/css" href="<?php echo (C("PUBLIC_URL")); ?>productList/css/component.css" />
	<script src="<?php echo (C("PUBLIC_URL")); ?>productList/js/modernizr.custom.js"></script>
	<!--[if IE]>
...
<body>
	...
	<div class="view">
		...
		<header class="bp-header cf">
                    <h1>店铺名 <span>Filterable Product Grid</span></h1>
			<nav>
				<a href="＃" class="bp-icon bp-icon-prev" data-info="previous Blueprint"><span>返回下载页</span></a>
				<a href="＃" class="bp-icon bp-icon-archive" data-info="Blueprints archive"><span>jQuery之家</span></a>
			</nav>
		</header>
		<!-- Grid -->
		<section class="grid grid--loading">
			<!-- Loader -->
			<img class="grid__loader" src="<?php echo (C("PUBLIC_URL")); ?>productListimages/grid.svg" width="60" alt="Loader image" />
			<!-- Grid sizer for a fluid Isotope (Masonry) layout -->
			<div class="grid__sizer"></div>
			<!-- Grid items -->
			<div class="grid__item shirts">
				<div class="slider">
					<div class="slider__item"><img src="<?php echo (C("PUBLIC_URL")); ?>productList/images/shirt.png" alt="Dummy" /></div>
					<div class="slider__item"><img src="<?php echo (C("PUBLIC_URL")); ?>productList/images/shirt.png" alt="Dummy" /></div>
					<div class="slider__item"><img src="<?php echo (C("PUBLIC_URL")); ?>productList/images/shirt.png" alt="Dummy" /></div>
				</div>
				<div class="meta">
			...
			<div class="grid__item shoes">
				<div class="slider">
					<div class="slider__item"><img src="<?php echo (C("PUBLIC_URL")); ?>productList/images/shoe.png" alt="Dummy" /></div>
					<div class="slider__item"><img src="<?php echo (C("PUBLIC_URL")); ?>productList/images/shoe.png" alt="Dummy" /></div>
					<div class="slider__item"><img src="<?php echo (C("PUBLIC_URL")); ?>productList/images/shoe.png" alt="Dummy" /></div>
				</div>
				<div class="meta">
			...
			<div class="grid__item dresses">
				<div class="slider">
					<div class="slider__item"><img src="<?php echo (C("PUBLIC_URL")); ?>productList/images/dress.png" alt="Dummy" /></div>
					<div class="slider__item"><img src="<?php echo (C("PUBLIC_URL")); ?>productList/images/dress.png" alt="Dummy" /></div>
					<div class="slider__item"><img src="<?php echo (C("PUBLIC_URL")); ?>productList/images/dress.png" alt="Dummy" /></div>
				</div>
				<div class="meta">
			...
			<div class="grid__item trousers">
				<div class="slider">
					<div class="slider__item"><img src="<?php echo (C("PUBLIC_URL")); ?>productList/images/trousers.png" alt="Dummy" /></div>
					<div class="slider__item"><img src="<?php echo (C("PUBLIC_URL")); ?>productList/images/trousers.png" alt="Dummy" /></div>
					<div class="slider__item"><img src="<?php echo (C("PUBLIC_URL")); ?>productList/images/trousers.png" alt="Dummy" /></div>
				</div>
				<div class="meta">
			...
			<div class="grid__item grid__item--size-a jackets">
				<div class="slider">
					<div class="slider__item"><img src="<?php echo (C("PUBLIC_URL")); ?>productList/images/jacket.png" alt="Dummy" /></div>
					<div class="slider__item"><img src="<?php echo (C("PUBLIC_URL")); ?>productList/images/jacket.png" alt="Dummy" /></div>
					<div class="slider__item"><img src="<?php echo (C("PUBLIC_URL")); ?>productList/images/jacket.png" alt="Dummy" /></div>
				</div>
				<div class="meta">
	...
	<script src="<?php echo (C("PUBLIC_URL")); ?>/productList/js/isotope.pkgd.min.js"></script>
	<script src="<?php echo (C("PUBLIC_URL")); ?>/productList/js/flickity.pkgd.min.js"></script>
	<script src="<?php echo (C("PUBLIC_URL")); ?>/productList/js/main.js"></script>
</body>
</html>